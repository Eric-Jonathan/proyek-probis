...
<body>
    <div class="container">
        <button class="btn btn-outline-danger btn-back mb-2" onclick="history.back()">
            ...
            <div class="row col-4">
                <div class="col-lg-12 mb-4">
                    <div class="card shadow-sm border-0 overflow-hidden" style="border-radius: 12px;">
                        <img src="{{ asset('upload_room/tes/tes_6.jpg') }}" class="card-img-top" alt="Kontena Hotel Lobby" style="height: 250px; object-fit: cover;">
                ...
                <div class="col-lg-12">
                    <div class="card border-0 shadow-sm mb-4" style="border-radius: 8px; border: 1px solid #e7e7e7 !important;">
                        <div class="card-body d-flex align-items-center p-3">
                            <div class="rounded-circle overflow-hidden d-flex align-items-center justify-content-center bg-light" style="width: 48px; height: 48px; border: 2px solid #ffbb00;">
                    ...
                    <div class="card border-0 shadow-sm mb-4" style="border-radius: 8px; border: 1px solid #e7e7e7 !important;">
                        <div class="card-body p-4">
                            ...
                            <textarea class="form-control" id="specialRequestsArea" rows="4" style="border-color: #868686; resize: vertical;"></textarea>
                        </div>
                    </div>
